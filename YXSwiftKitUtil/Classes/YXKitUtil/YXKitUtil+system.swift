...
public enum YXSwiftKitUtilOpenAppStoreType {
...
public extension YXSwiftKitUtil {
    ...
    ///打开软件对应的App Store页面
    func openAppStorePage(openType: YXSwiftKitUtilOpenAppStoreType, appleID: String) -> Void {
        switch openType {
        case .app:
    ...
    func openAppStoreReviewPage(openType: YXSwiftKitUtilOpenAppStoreType, appleID: String = "", openWriteAction: Bool = true) -> Void {
        switch openType {
        case .app:
...
extension YXSwiftKitUtil : SKStoreProductViewControllerDelegate {
