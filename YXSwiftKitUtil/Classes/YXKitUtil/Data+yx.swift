...
public enum YXSwiftKitUtilEncryType {
    case md5
    case sha1
    case sha224
    case sha256
...
extension Data: YXSwiftKitUtilNameSpaceWrappable {
    
}

public extension YXSwiftKitUtilNameSpace where T == Data {
    ///base64解码
...
private extension YXSwiftKitUtilNameSpace where T == Data {
