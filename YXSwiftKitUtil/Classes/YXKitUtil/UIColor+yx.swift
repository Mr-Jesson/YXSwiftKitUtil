...
extension UIColor: YXSwiftKitUtilNameSpaceWrappable {

}

public extension YXSwiftKitUtilNameSpace where T : UIColor {
...
private extension YXSwiftKitUtilNameSpace where T : UIColor {
    ///通过十六进制字符串获取颜色
