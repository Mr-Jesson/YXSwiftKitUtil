...
extension UIImage: YXSwiftKitUtilNameSpaceWrappable {

}

public extension YXSwiftKitUtilNameSpace where T : UIImage {
    ///通过颜色获取纯色图片
    static func getImage(color: UIColor, size: CGSize = CGSize(width: 1, height: 1)) -> UIImage {
        return YXSwiftKitUtil.shared.getImage(color: color, size: size)
    }
    
    ///线性渐变
    static func getLinearGradientImage(colors: [UIColor], directionType: YXSwiftKitUtilGradientDirection, size: CGSize = CGSize(width: 100, height: 100)) -> UIImage {
        return YXSwiftKitUtil.shared.getLinearGradientImage(colors: colors, directionType: directionType, size: size)
    }
    
    ///角度渐变
    static func getRadialGradientImage(colors: [UIColor], raduis: CGFloat, size: CGSize = CGSize(width: 100, height: 100)) -> UIImage {
        return YXSwiftKitUtil.shared.getRadialGradientImage(colors: colors, raduis: raduis, size: size)
    }
...
private extension YXSwiftKitUtilNameSpace where T : UIImage {
